...
describe('CheckboxFacetList', () => {
  ...
  it('Component should render correctly', () => {
    ...
    expect(screen.getByRole('button', { name: 'stripes-inventory-components.more' })).toBeInTheDocument();
  });
  ...
  it('noMatchingOptions should be render when dataOptions is empty', () => {
    ...
    expect(screen.getByText('stripes-inventory-components.noMatchingOptions')).toBeInTheDocument();
  });
