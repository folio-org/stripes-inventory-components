...
describe('ItemFilters', () => {
  ...
  it('Should Clear selected filters for items Created Date', async () => {
    ...
    const clearButton = screen.getByRole('button', { name: 'Clear selected filters for "Date created"' });
  ...
  it('Should Clear selected filters for itemsUpdatedDate', async () => {
    ...
    const clearButton = screen.getByRole('button', { name: 'Clear selected filters for "Date updated"' });
