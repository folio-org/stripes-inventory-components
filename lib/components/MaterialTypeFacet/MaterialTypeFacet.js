...
const MaterialTypeFacet = ({
  ...
  return (
    <MultiSelectionFacet
      id={name}
      label={intl.formatMessage({ id: 'stripes-inventory-components.facet.materialType' })}
...
MaterialTypeFacet.propTypes = propTypes;

export { MaterialTypeFacet };
