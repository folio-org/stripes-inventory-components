...
const ModeIssuanceFacet = ({
  ...
  return (
    <Facet
      id={name}
      name={name}
      label={intl.formatMessage({ id: 'stripes-inventory-components.facet.modeOfIssuance' })}
...
ModeIssuanceFacet.propTypes = propTypes;

export { ModeIssuanceFacet };
