...
export const FACETS = {
  ...
  // `NEW_CALL_NUMBERS_HELD_BY` is used when the `browse` 1.5 interface is available,
  // as it requires a different query parameter.
...
export const FACETS_CQL = {
  ...
  CALL_NUMBERS_EFFECTIVE_LOCATION: 'instances.locationId',
  LANGUAGES: 'languages',
...
export const FACETS_TO_REQUEST = {
  ...
  [FACETS.CALL_NUMBERS_SHARED]: FACETS_CQL.INSTANCES_SHARED,
  ...
  [FACETS.NEW_CALL_NUMBERS_HELD_BY]: FACETS_CQL.INSTANCES_HELD_BY,
  ...
  [FACETS.CALL_NUMBERS_EFFECTIVE_LOCATION]: FACETS_CQL.CALL_NUMBERS_EFFECTIVE_LOCATION,
