...
export const browseCallNumberIndexToId = {
  [browseCallNumberOptions.CALL_NUMBERS]: 'all',
  [browseCallNumberOptions.DEWEY]: 'dewey',
  [browseCallNumberOptions.LIBRARY_OF_CONGRESS]: 'lc',
  [browseCallNumberOptions.LOCAL]: 'local',
  [browseCallNumberOptions.NATIONAL_LIBRARY_OF_MEDICINE]: 'nlm',
  [browseCallNumberOptions.OTHER]: 'other',
  [browseCallNumberOptions.SUPERINTENDENT]: 'sudoc',
};
