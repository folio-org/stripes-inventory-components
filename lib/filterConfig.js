...
export const queryIndexesMap = {
  [queryIndexes.INSTANCE_KEYWORD]: { label: 'stripes-inventory-components.search.keyword', value: queryIndexes.INSTANCE_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or hrid=="%{query.query}" or id=="%{query.query}" or identifiers.value="%{query.query}"' },
  ...
  [queryIndexes.IDENTIFIER]: { label: 'stripes-inventory-components.search.identifierAll', value: queryIndexes.IDENTIFIER, queryTemplate: 'identifiers.value="%{query.query}" or isbn="%{query.query}" or issn="%{query.query}"' },
  ...
  [queryIndexes.HOLDINGS_KEYWORD]: { label: 'stripes-inventory-components.search.keyword', value: queryIndexes.HOLDINGS_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or holdings.hrid=="%{query.query}" or holdings.id=="%{query.query}" or identifiers.value="%{query.query}"' },
  ...
  [queryIndexes.ITEMS_KEYWORD]: { label: 'stripes-inventory-components.search.item.keyword', value: queryIndexes.ITEMS_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or item.hrid=="%{query.query}" or item.id=="%{query.query}" or items.barcode=="%{query.query}" or identifiers.value="%{query.query}"' },
