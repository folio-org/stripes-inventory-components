...
export const queryIndexesMap = {
  ...
  [queryIndexes.ITEMS_KEYWORD]: { label: 'stripes-inventory-components.search.keyword', value: queryIndexes.ITEMS_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or item.hrid=="%{query.query}" or item.id=="%{query.query}" or items.barcode=="%{query.query}"' },
