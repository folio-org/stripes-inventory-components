...
export const queryIndexesMap = {
  [queryIndexes.INSTANCE_KEYWORD]: { label: 'stripes-inventory-components.search.keyword', value: queryIndexes.INSTANCE_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or hrid=="%{query.query}" or id=="%{query.query}"' },
