...
export const queryIndexesMap = {
  ...
  [queryIndexes.HOLDINGS_KEYWORD]: { label: 'stripes-inventory-components.search.keyword', value: queryIndexes.HOLDINGS_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or holdings.hrid=="%{query.query}" or holdings.id=="%{query.query}"' },
  ...
  [queryIndexes.ITEMS_KEYWORD]: { label: 'stripes-inventory-components.search.item.keyword', value: queryIndexes.ITEMS_KEYWORD, queryTemplate: 'keyword all "%{query.query}" or isbn="%{query.query}" or issn="%{query.query}" or item.hrid=="%{query.query}" or item.id=="%{query.query}" or items.barcode=="%{query.query}"' },
