...
export const getItemStatusesOptions = (selectedFiltersId, values, itemStatuses, intl) => {
  if (!itemStatuses) return null;
  ...
  return [
    ...restFilters,
    ...getSelectedItemStatusOptions(selectedFiltersId, values, itemStatuses, intl),
  ];
};
