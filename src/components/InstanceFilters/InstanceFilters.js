...
const InstanceFilters = props => {
  ...
  return (
    <AccordionSet accordionStatus={accordions} onToggle={onToggleSection}>
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.filters.${FACETS.EFFECTIVE_LOCATION}`} />}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.instances.${FACETS.LANGUAGE}`} />}
        id={FACETS.LANGUAGE}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.instances.resourceType" />}
        id={FACETS.RESOURCE}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.instanceFormat" />}
        id={FACETS.FORMAT}
        name={FACETS.FORMAT}
        closedByDefault
        header={FilterAccordionHeader}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.modeOfIssuance" />}
        id={FACETS.MODE}
        name={FACETS.MODE}
        closedByDefault
        header={FilterAccordionHeader}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.natureOfContentTerms" />}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.${FACETS.STAFF_SUPPRESS}`} />}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.discoverySuppress" />}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.statisticalCode" />}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.${FACETS.CREATED_DATE}`} />}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.${FACETS.UPDATED_DATE}`} />}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.instanceStatusShort" />}
        id={FACETS.STATUS}
        name={FACETS.STATUS}
        closedByDefault
        header={FilterAccordionHeader}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.${FACETS.SOURCE}`} />}
        id={FACETS.SOURCE}
        name={FACETS.SOURCE}
        closedByDefault
        header={FilterAccordionHeader}
