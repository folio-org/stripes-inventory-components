...
const ItemFilters = (props) => {
  ...
  return (
    <AccordionSet accordionStatus={accordions} onToggle={onToggleSection}>
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.item.status" />}
      ...
      <Accordion
        label={<FormattedMessage id="stripes-inventory-components.holdings.permanentLocation" />}
      ...
      <Accordion
        label={<FormattedMessage id={`stripes-inventory-components.${FACETS.MATERIAL_TYPE}`} />}
