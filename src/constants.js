...
export const hridSettingsSections = [
  {
    type: 'instances',
    title: 'stripes-inventory-components.hridHandling.sectionHeader1',
  },
  {
    type: 'holdings',
    title: 'stripes-inventory-components.hridHandling.sectionHeader2',
  },
  {
    type: 'items',
    title: 'stripes-inventory-components.hridHandling.sectionHeader3',
  },
];
...
export const actionMenuDisplayPerms = [
  'stripes-inventory-components.item.create',
  'stripes-inventory-components.item.edit',
  'stripes-inventory-components.item.delete',
  'ui-requests.create',
  'stripes-inventory-components.items.mark-items-withdrawn',
  'stripes-inventory-components.items.mark-intellectual-item',
  'stripes-inventory-components.items.mark-restricted',
  'stripes-inventory-components.items.mark-unknown',
  'stripes-inventory-components.items.mark-unavailable',
  'stripes-inventory-components.items.mark-long-missing',
  'stripes-inventory-components.items.mark-in-process-non-requestable',
];
