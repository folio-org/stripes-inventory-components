...
export const validateRequiredField = value => {
  ...
  return <FormattedMessage id="stripes-inventory-components.hridHandling.validation.enterValue" />;
};
...
export const validateFieldLength = (value, maxLength) => {
  if (value) {
    ...
    return (
      <FormattedMessage
        id="stripes-inventory-components.hridHandling.validation.maxLength"
        values={{ maxLength }}
      />
    );
  }
...
export const validateNumericField = value => {
  if (value) {
    ...
    return <FormattedMessage id="stripes-inventory-components.hridHandling.validation.startWithField" />;
  }
...
export const validateAlphaNumericField = value => {
  if (value) {
    ...
    return <FormattedMessage id="stripes-inventory-components.hridHandling.validation.assignPrefixField" />;
  }
  ...
  if (values[listName] && values[listName].length) {
    values[listName].forEach((item, i) => {
      ...
      optionalField.textFields.forEach((field) => {
        if (!item || !item[field]) {
          entryErrors[field] = <FormattedMessage id="stripes-inventory-components.fillIn" />;
      ...
      optionalField.selectFields.forEach((field) => {
        if (!item || !item[field]) {
          entryErrors[field] = <FormattedMessage id="stripes-inventory-components.selectToContinue" />;
          errorList[i] = entryErrors;
        }
      });
    });
...
export const staffOnlyFormatter = x => (get(x, ['staffOnly'])
  ? <FormattedMessage id="stripes-inventory-components.yes" />
  : <FormattedMessage id="stripes-inventory-components.no" />);
